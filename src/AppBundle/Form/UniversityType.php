...
class UniversityType extends AbstractType {
    ...
    {
        $builder
            ->add('name', TextType::class, array('label' => 'University Name', 'attr' => array('class' => 'form-control', 'style' => 'margin-bottom:15px')))
            ->add('code', TextType::class, array('label' => 'University Code', 'attr' => array('class' => 'form-control', 'style' => 'margin-bottom:15px')))
